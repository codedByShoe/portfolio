@props(['modalFor', 'heading', 'excerpt'])
<div x-data x-init="$watch('$store.authModal.{{ $modalFor }}', function(value) {
    if (value === true) {
    ...
    <template x-teleport="body">
        ...
        <div x-show="$store.authModal.{{ $modalFor }}" x-transition:enter="transition ease-out duration-300"
            ...
            <button @click="$store.authModal.{{ $modalFor }} = false"
                ...
                <div class="relative w-full max-w-sm mx-auto lg:mb-0">
                    <div class="relative text-center">
                        ...
                        <div class="flex flex-col mb-6 space-y-2">
                            ...
                            <p class="text-sm text-neutral-500">{{ $excerpt }}</p>
                        </div>
                        {{ $slot }}
                    </div>
